(function($) {
  ...
  /*OWL Team*/
	...
	$('.gla_main_menu_content_menu div ul li').on("click", "a", function(e){
		$(this).parent().parent().parent().parent().prev('.gla_main_menu_content').toggleClass('active');
		$(this).parent().parent().parent().parent().prev().prev('.gla_main_menu').toggleClass('active');
	...
	/* Destop Scroll Menu */
	$('.gla_default_menu ul li').on("click", "a", function(e){
		console.log($(this).attr("href"));
		$('html, body').stop().animate({
			scrollTop: $($(this).attr("href")).offset().top
		}, 400);
